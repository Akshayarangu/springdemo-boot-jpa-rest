...
public class ProductApi
{
	...
	public ResponseEntity<List<Product>> searchByName(@PathVariable("name")String productName)
	{
		return new ResponseEntity<List<Product>>(repository.findByProductNameIgnoreCase(productName).get(),HttpStatus.OK);
	}
