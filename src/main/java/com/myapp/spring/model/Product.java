...
public class Product {
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO) //For Id generation 
	...
	@Column(name="PRDUCT_AVAILABE",nullable=false)
	private LocalDate productAvailable;

	@Column(name="PRDUCT_IMAGE_URL",nullable=false,unique=true)
...
public Product (String productName, Double price, Double starRating, LocalDate productAvailable,
		String imageUrl) {
...
&& Objects.equals(productAvailable, other.productAvailable) && Objects.equals(productId, other.productId)
